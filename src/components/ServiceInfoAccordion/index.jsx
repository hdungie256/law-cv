...
export default function ServiceInfoAccordion(props) {
  ...
  return (
    <div className='accordion'>
      <Accordion defaultExpanded  className='accordion' style={{width: '100%', marginTop: '20px'}}>
        <AccordionSummary
          expandIcon={<ArrowDropDownIcon />}
          aria-controls="panel1-content"
          id="panel1-header"
        >
          <Typography style={{ color: '#black'}}><b>2. Thông tin {info.dtype}</b></Typography>
        </AccordionSummary>
        <AccordionDetails>
            ...
            <div id='dialog-service-group'>
                <div id='dialog-serivce-group-label-wrapper1' style={{'margin-bottom': '7px'}}> <label id='dialog-service-group-label1'> <b> Nhóm sản phẩm</b></label> </div>
            ...
            {(props.type === 'Đăng ký nhãn hiệu quốc tế') &&
              <div id='dialog-service-country'>
                  <div id='dialog-serivce-group-label-wrapper1' style={{'margin-bottom': '7px'}}> <label id='dialog-service-group-label1'> <b> Quốc gia chỉ định bảo hộ</b></label> </div>
            ...
            {props.type === 'KDCN' &&
              <div id='dialog-service-group'>
                <div id='dialog-service-group-label-wrapper1' style={{'margin-bottom': '7px'}}> <label id='dialog-service-group-label1'> <b> Phân loại</b></label> </div>
